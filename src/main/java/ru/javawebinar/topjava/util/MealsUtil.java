...
public class MealsUtil {
    ...
    public static final List<Meal> meals2 = Arrays.asList(
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 30, 10, 0), "Завтрак пользователя 2", 490),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 30, 13, 0), "Обед пользователя 2", 950),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 30, 20, 0), "Ужин пользователя 2", 600)
    );
